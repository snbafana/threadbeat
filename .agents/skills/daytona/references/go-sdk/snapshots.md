...
Daytona provides methods to create snapshots using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/snapshots) or programmatically using the Daytona [Python](../python-sdk/sync/snapshot.md), [TypeScript](../typescript-sdk/snapshot.md), [Ruby](../ruby-sdk/snapshot.md), [Go](./daytona.md#SnapshotService), [Java](https://www.daytona.io/docs/en/java-sdk/snapshot) **SDKs**, [CLI](../cli.md#daytona-snapshot), or [API](../api/README.md#daytona/tag/snapshots).
...
Daytona provides methods to create GPU snapshots using the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/snapshots) or programmatically using the Daytona [Python](../python-sdk/sync/snapshot.md), [TypeScript](../typescript-sdk/snapshot.md), [Ruby](../ruby-sdk/snapshot.md), [Go](./daytona.md#SnapshotService), [Java](https://www.daytona.io/docs/en/java-sdk/snapshot) **SDKs**, or [API](../api/README.md#daytona/tag/snapshots).
